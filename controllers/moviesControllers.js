...
function GetMovieByID(req, res) {
  return __awaiter(this, void 0, void 0, function* () {
    ...
    try {
      ...
      return res
        .status(500)
        .json({ error: "An error occurred while retrieving movie" });
    }
  });
}
    ...
    if (q) {
      try {
        ...
        return res.status(500).json({
          error: "An error occurred while retrieving movies",
          movies: [],
        });
      }
    }
  ...
  return __awaiter(this, void 0, void 0, function* () {
    ...
    try {
      const result = Movie.update(
        { name: movie.name, duration: movie.duration, rating: movie.rating },
        { where: { id } }
      );
      return res.json({
        status: "success",
